...
from:
"My DMV Cleaning Services <onboarding@resend.dev>",
...
<p>Thank you for choosing My DMV Cleaning Services LLC.</p>
...
<p><b>Name:</b> ${contract.name}</p>

<p><b>Email:</b> ${contract.email}</p>

<p><b>Signed Name:</b> ${contract.typedName}</p>
